...
public:
    ...
    void setupUi(QMainWindow *Minify)
    {
        ...
        Minify->setStyleSheet(QLatin1String("background-color: qlineargradient(spread:reflect, x1:0.428, y1:0.422, x2:1, y2:1, stop:0 rgba(232, 155, 0, 255), stop:1 rgba(0, 0, 0, 255));\n"
""));
...
"font-family: MS UI Gothic;"));
        JavaSriptRadioButton->setChecked(true);
...
"\n"
"}"));
        CSSRadioButton->setChecked(false);
...
"	border-color: rgb(255, 255, 205, 0);\n"
"}"));
...
""));
        ...
        QPalette palette1;
        QBrush brush3(QColor(255, 255, 205, 255));
